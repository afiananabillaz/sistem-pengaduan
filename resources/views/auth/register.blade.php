<x-login-layout>
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-6">
                <div id="auth-left">
                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="npwp" class="form-control form-control-xl" placeholder="NPWP" required>
                            <div class="form-control-icon">
                                <i class="bi bi-pencil"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="nama" class="form-control form-control-xl" placeholder="Nama Instansi" required>
                            <div class="form-control-icon">
                                <i class="bi bi-building"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="no_hp" class="form-control form-control-xl" placeholder="Nomor Handphone" required>
                            <div class="form-control-icon">
            ...
            <div class="col-lg-6">
                <div>
                    <img src="{{ asset('img/illustration/5.png') }}" alt="Thumb" style="width: 80%; margin-top: 140px;">
                </div>
            </div>
        </div>
