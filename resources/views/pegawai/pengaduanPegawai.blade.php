                                    ...
                                    <table class="table table-striped" id="table1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-info" data-bs-toggle="modal" data-bs-target="#tanggapi{{ $pengaduan->id }}" style="cursor:pointer">Tanggapi</span>

                                                    <!--login form Modal -->
                                                    <div class="modal fade text-left" id="tanggapi{{ $pengaduan->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title" id="myModalLabel33">Tanggapi Pengaduan</h4>
                                                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                                                        <i data-feather="x"></i>
                                                                    </button>
                                                                </div>

                                                                <form action="{{ route('pegawai.tanggapan', ['id'=> $pengaduan->id]) }}" method="post" enctype="multipart/form-data">
                                                                    @csrf
